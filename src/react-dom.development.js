...
function updateHostRoot(current$$1, workInProgress, renderExpirationTime) {
  ...
  if ( // TODO: This is a bug because if we render null after having hydrating,
  // we'll reenter hydration state at the next update which will then
  // trigger hydration warnings.
  (current$$1 === null || current$$1.child === null) && root.hydrate && enterHydrationState(workInProgress)) {
